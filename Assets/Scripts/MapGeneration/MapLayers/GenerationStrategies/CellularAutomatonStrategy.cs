...
namespace CuteNewtTest.MapGeneration.Strategies
{
    public class CellularAutomatonStrategy : IMapGenerationStrategy
    {
        ...
        void UpdateSettings()
        {
            ...
            _settings.TrimLeftovers = _trimLeftovers;
        ...
        class CellularAutomatonSettings
        {
            ...
            public bool TrimLeftovers;
            [ShowIf(nameof(FillHoles)), AllowNesting, Range(0, 3)] public int TrimThreshold = 3;
